...
export interface DirectusImageProps extends Omit<React.ImgHTMLAttributes<HTMLImageElement>, 'src'> {
  uuid: string;
  fill?: boolean;
}

const DirectusImage: React.FC<DirectusImageProps> = ({ uuid, alt, width, height, fill, style, ...rest }) => {
